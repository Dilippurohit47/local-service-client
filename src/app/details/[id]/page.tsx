...
const page = () => {
  ...
  return (
    <div className="mt-14 flex h-[200vh] w-screen  bg-[#FFFFFF]">
      <div className="flex flex-col  py-12 px-16 w-2/4 h-full">
        ...
        <div className="shadow-lg border-1 mt-2 rounded-lg px-3 py-2">
          ...
          <p className="mt-2 text-sm text-[#595c6d]">
            ...
            professional committed to delivering high-quality services that meet
            your specific needs. With over [X years] of experience in the field,
            I specialize in [mention key services, e.g., plumbing repairs,
            electrical installations, and carpentry]. My approach focuses on
            reliability, attention to detail, and ensuring customer satisfaction
            in every project I undertake. I am available to assist you during
            [working hours and days, e.g., 9:00 AM to 6:00 PM, Monday to
            Saturday], offering competitive rates without compromising on
            quality. Let me help you with your [specific services] needs and
            ensure the best possible results for your requirements.
          </p>
        </div>
      </div>
      ...
      <div className=" flex flex-col gap-6    py-12 px-16 w-2/4 h-full">
        ...
        <div className="shadow-lg border-1 flex flex-col gap-3  rounded-lg px-3 py-2">
          <div>
            <input placeholder="write message here..." className="px-2 py-2 focus:outline-none border-2  w-full rounded-md" />
          </div>
          <button className="px-6 py-2 w-full bg-blue-600 hover:bg-blue-500 transition ease-in-out duration-300 text-white flex gap-2 justify-center items-center rounded-md ">
           send  Message{" "}
